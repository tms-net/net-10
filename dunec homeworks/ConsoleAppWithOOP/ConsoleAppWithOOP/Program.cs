...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        {
            car.Stop();
            Console.WriteLine($"\n{car.Make}-{car.Model} was successfully stopped");
        }
        else
        {
        ...
        {
            truck.Stop();
            Console.WriteLine($"\n{truck.Make}-{truck.Model} was successfully stopped");
        }
        else
        {
