...
-- One to One Relationship
   ...
   -- ProductDetails
		...
		ALTER TABLE Products
		ADD Details nvarchar(max); -- JSON

-- Many to Many Relationship

-- У продукта одна категория
-- У категории много продуктов

-- У продукта много (сущностей) тегов (#[spring collection] #[new])
-- У тега много (сущностей) продуктов (или что-то другое)
