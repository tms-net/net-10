...
namespace CsvSerializer
{
    ...
    public sealed partial class CsvSerializer : CsvSerializerAbstraction<DataRow>
    {
        ...
        public static string Serialize(CsvSerializerSettings csvSerializerSettings, DataTable collection)
        {
            StringBuilder sbColumns = new StringBuilder();
            string csvSeparator = csvSerializerSettings.Delimiter;
            ...
            return sbColumns.ToString() + (new CsvSerializer(csvSerializerSettings)).CustomSerialize(collection.Rows.Cast<DataRow>().ToArray());
        }
        ...
        public static DataTable Deserialize(CsvSerializerSettings csvSerializerSettings, string csvString)
        {
            return (new CsvSerializer(csvSerializerSettings)).CustomDeserialize(csvString).ToArray().CopyToDataTable<DataRow>();
        }
